...
@section('title', 'Persetujuan Atasan')

@section('content')
<div class="card card mb-3 shadow rounded-2">
    <div class="card-body">
        <form method="GET" action="{{ route('persetujuan-atasan.index') }}" class="row g-2 align-items-end">
...
<div class="card shadow rounded-2">
    <div class="card-header bg-white d-flex justify-content-between align-items-center">
        <h5 class="mb-0 fw-bold">Daftar Persetujuan Atasan</h5>
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton">
                <li>
                    <a class="dropdown-item" href="{{ route('persetujuan-atasan.export.pdf') }}">
                        <i class="bx bxs-file-pdf me-1"></i> Export PDF
                    </a>
                </li>
                <li>
                    <a class="dropdown-item" href="{{ route('persetujuan-atasan.export.excel') }}">
    ...
    <div class="card-body">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
             ...
             {{-- 🔍 Manual Search --}}
            <form action="{{ route('persetujuan-atasan.index') }}" method="GET" class="d-flex align-items-center">
        ...
        <div class="table-responsive">
            <table class="table table-striped table-bordered align-middle">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="10" class="text-center">Belum ada data perjalanan dinas</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
...
$(document).ready(function () {
    $('#showEntries').on('change', function () {
        ...
        $.ajax({
            url: "{{ route('persetujuan-atasan.index') }}",
            type: "GET",
